...
Blackfury is written in Go.  We prefer to use the latest version of go because this will prevent mixed runtimes, and thus, errors. 
...
```bash
git clone https://github.com/Exfury/Blackfury
cd Blackfury
go install ./...
code .
```
...
* Each major version of blackfury should change the module path in go.mod.  
