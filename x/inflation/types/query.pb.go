...
func init() {
	...
	proto.RegisterType((*QueryCirculatingSupplyRequest)(nil), "blackfury.inflation.v1.QueryCirculatingSupplyRequest")
	proto.RegisterType((*QueryCirculatingSupplyResponse)(nil), "blackfury.inflation.v1.QueryCirculatingSupplyResponse")
...
func init() { proto.RegisterFile("blackfury/inflation/v1/query.proto", fileDescriptor_bd7bc906141a59c4) }
...
func (c *queryClient) CirculatingSupply(ctx context.Context, in *QueryCirculatingSupplyRequest, opts ...grpc.CallOption) (*QueryCirculatingSupplyResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/blackfury.inflation.v1.Query/CirculatingSupply", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_CirculatingSupply_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/blackfury.inflation.v1.Query/CirculatingSupply",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
