...
// source: blackfury/fees/v1/fees.proto
...
func init() {
	proto.RegisterType((*Fee)(nil), "blackfury.fees.v1.Fee")
}

func init() { proto.RegisterFile("blackfury/fees/v1/fees.proto", fileDescriptor_a3e4bdb330dad752) }
