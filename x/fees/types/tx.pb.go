...
// source: blackfury/fees/v1/tx.proto
...
func init() {
	proto.RegisterType((*MsgRegisterFee)(nil), "blackfury.fees.v1.MsgRegisterFee")
	proto.RegisterType((*MsgRegisterFeeResponse)(nil), "blackfury.fees.v1.MsgRegisterFeeResponse")
	proto.RegisterType((*MsgCancelFee)(nil), "blackfury.fees.v1.MsgCancelFee")
	proto.RegisterType((*MsgCancelFeeResponse)(nil), "blackfury.fees.v1.MsgCancelFeeResponse")
	proto.RegisterType((*MsgUpdateFee)(nil), "blackfury.fees.v1.MsgUpdateFee")
	proto.RegisterType((*MsgUpdateFeeResponse)(nil), "blackfury.fees.v1.MsgUpdateFeeResponse")
}

func init() { proto.RegisterFile("blackfury/fees/v1/tx.proto", fileDescriptor_c1aa8935372a4859) }
...
func (c *msgClient) RegisterFee(ctx context.Context, in *MsgRegisterFee, opts ...grpc.CallOption) (*MsgRegisterFeeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/blackfury.fees.v1.Msg/RegisterFee", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) CancelFee(ctx context.Context, in *MsgCancelFee, opts ...grpc.CallOption) (*MsgCancelFeeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/blackfury.fees.v1.Msg/CancelFee", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdateFee(ctx context.Context, in *MsgUpdateFee, opts ...grpc.CallOption) (*MsgUpdateFeeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/blackfury.fees.v1.Msg/UpdateFee", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_RegisterFee_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/blackfury.fees.v1.Msg/RegisterFee",
	}
...
func _Msg_CancelFee_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/blackfury.fees.v1.Msg/CancelFee",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_UpdateFee_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/blackfury.fees.v1.Msg/UpdateFee",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "blackfury.fees.v1.Msg",
	...
	Metadata: "blackfury/fees/v1/tx.proto",
}
