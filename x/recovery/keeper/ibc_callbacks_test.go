...
import (
	...
	"github.com/Exfury/Blackfury/v6/testutil"
	...
	"github.com/Exfury/Blackfury/v6/x/recovery/keeper"
...
func (suite *KeeperTestSuite) TestOnRecvPacket() {
	...
	coins := sdk.NewCoins(
		sdk.NewCoin("ablackfury", sdk.NewInt(1000)),
